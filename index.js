var authConfig = {
    ...
    "refresh_token": 
"1//0gb2C0ZntEuubCgYIARAAGBASNwF-L9Iruto8m_6MNjLid8bJN63qJ2WPVU-IWdKObsYlby1tbig8cZZmfZIEHRW0vLeVeLNhgOg", 
// Authorization token
...
initial-scale=1.0,maximum-scale=1.0, user-scalable=no"/>
      ...
      <script>var main_color = "${authConfig.main_color}";var accent_color = 
"${authConfig.accent_color}";var dark = ${authConfig.dark_theme};var search = 
${authConfig.search};</script>
      <script 
src="//cdn.jsdelivr.net/combine/gh/jquery/jquery@3.2/dist/jquery.min.js,gh/kulokenci/goindex-drive@${authConfig.version}/themes/${authConfig.theme}/app.js"></script>
  </head>
  <body>
  </body>
  </html>
...
iconLink, thumbnailLink)";
    ...
    async search(query){
      ...
      if(authConfig.root=="root"){
          params = 
{'corpus':'user','includeItemsFromAllDrives':false,'supportsAllDrives':false};
          params.q = `name contains '${query}' and trashed = false`;
      }else{
          params = {'corpora':'drive', 'driveId': authConfig.root, 
...
iconLink, thumbnailLink)";
    ...
    async _findDirId(parent, name){
      ...
      let url = 'https://www.googleapis.com/drive/v3/files';
      let params = {'includeItemsFromAllDrives':true,'supportsAllDrives':true};
      params.q = `'${parent}' in parents and mimeType = 
'application/vnd.google-apps.folder' and name = '${name}' and trashed = false`;
